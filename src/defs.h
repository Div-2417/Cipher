...
//position based evaluation, earlier Gotya had this but with different values
...
static const int kingMidPST[64] = {
...
static const int kingEndPST[64] = {
...
// mirror square for black (flip rank, keep file)
